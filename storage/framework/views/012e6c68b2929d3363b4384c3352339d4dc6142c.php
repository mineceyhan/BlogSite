                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?php echo e(url('register')); ?>">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                <button type="submit" class="btn btn-primary" href="">Hesap Oluştur</button>
                                                <?php if($errors->any()): ?>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="<?php echo e(url('loginPage')); ?>">Hesabın var mı? Giriş Yap!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\Mine\Desktop\BlogSite\resources\views/auth/register.blade.php ENDPATH**/ ?>